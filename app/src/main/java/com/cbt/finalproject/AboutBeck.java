...
public class AboutBeck extends AppCompatActivity {
    String aboutCBT;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
//        setContentView(R.layout.activity_about);
        aboutCBT = getResources().getString(R.string.aboutBeck);
        simulateDayNight(/* DAY */ 0);
        this.setTitle("About Beck Scale");
        Element adsElement = new Element();
        adsElement.setTitle("About CBT ");

        View aboutPage = new AboutPage(this)
                .isRTL(false)
//                .addItem(adsElement)
//                .addItem(new Element().setTitle("About the App"))
                .setImage(R.drawable.beckk)
//                .addItem(new Element().setTitle("Version 1.2"))

                .setDescription(aboutCBT)
    ...
    Element getCopyRightsElement() {
        ...
        copyRightsElement.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(AboutBeck.this, copyrights, Toast.LENGTH_SHORT).show();
            }
        });
