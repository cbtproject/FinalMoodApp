...
public class AboutLifeStyle extends AppCompatActivity {
    String aboutlifeStyle;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
//        setContentView(R.layout.activity_about);
        aboutlifeStyle = getResources().getString(R.string.aboutLifeStyle);
        simulateDayNight(/* DAY */ 0);
        this.setTitle("About Life Style");
...
//                .addItem(new Element().setTitle("About the App"))
                .setImage(R.drawable.lifestyle)
//                .addItem(new Element().setTitle("Version 1.2"))

                .setDescription(aboutlifeStyle)
    ...
    Element getCopyRightsElement() {
        ...
        copyRightsElement.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(AboutLifeStyle.this, copyrights, Toast.LENGTH_SHORT).show();
            }
        });
