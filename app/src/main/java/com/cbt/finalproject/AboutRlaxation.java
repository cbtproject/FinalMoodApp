...
public class AboutRlaxation extends AppCompatActivity {
    String aboutRelax;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
//        setContentView(R.layout.activity_about);
        aboutRelax = getResources().getString(R.string.aboutRelaxation);
        simulateDayNight(/* DAY */ 0);
        this.setTitle("About Relaxation");
...
//                .addItem(new Element().setTitle("About the App"))
                .setImage(R.drawable.relax)
//                .addItem(new Element().setTitle("Version 1.2"))

                .setDescription(aboutRelax)
    ...
    Element getCopyRightsElement() {
        ...
        copyRightsElement.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(AboutRlaxation.this, copyrights, Toast.LENGTH_SHORT).show();
            }
        });
