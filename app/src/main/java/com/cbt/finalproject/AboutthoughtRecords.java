...
public class AboutthoughtRecords extends AppCompatActivity {
    String aboutthoughtRecords;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
//        setContentView(R.layout.activity_about);
        aboutthoughtRecords = getResources().getString(R.string.aboutThoughtRecord);
        simulateDayNight(/* DAY */ 0);
        this.setTitle("About Thought Records");
...
//                .addItem(new Element().setTitle("Version 1.2"))
                ...
                .setDescription(aboutthoughtRecords)
    ...
    Element getCopyRightsElement() {
        ...
        copyRightsElement.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(AboutthoughtRecords.this, copyrights, Toast.LENGTH_SHORT).show();
            }
        });
