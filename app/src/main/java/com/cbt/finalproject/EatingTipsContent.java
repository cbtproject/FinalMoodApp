...
public class EatingTipsContent extends AppCompatActivity {
    String EatingTipsContent;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
//        setContentView(R.layout.activity_about);
        EatingTipsContent = getResources().getString(R.string.eatingTipsContent);
        simulateDayNight(/* DAY */ 0);
        this.setTitle("Eating Tips");
        Element adsElement = new Element();
        adsElement.setTitle("Eating Tips ");

        View aboutPage = new AboutPage(this)
                .isRTL(false)
//                .addItem(adsElement)
//                .addItem(new Element().setTitle("About the App"))
                .setImage(R.drawable.eating_tips)
//                .addItem(new Element().setTitle("Version 1.2"))

                .setDescription(EatingTipsContent)
    ...
    Element getCopyRightsElement() {
        ...
        copyRightsElement.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(EatingTipsContent.this, copyrights, Toast.LENGTH_SHORT).show();
            }
        });
