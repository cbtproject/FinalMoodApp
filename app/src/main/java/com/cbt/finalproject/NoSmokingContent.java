...
public class NoSmokingContent extends AppCompatActivity {
    String stopSmokingContent;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
//        setContentView(R.layout.activity_about);
        stopSmokingContent = getResources().getString(R.string.stopSmokingContent);
        simulateDayNight(/* DAY */ 0);
        this.setTitle("stop Smoking");
        Element adsElement = new Element();
        adsElement.setTitle("stop Smoking");

        View aboutPage = new AboutPage(this)
                .isRTL(false)
//                .addItem(adsElement)
//                .addItem(new Element().setTitle("About the App"))
                .setImage(R.drawable.no_smoking)
//                .addItem(new Element().setTitle("Version 1.2"))

                .setDescription(stopSmokingContent)
    ...
    Element getCopyRightsElement() {
        ...
        copyRightsElement.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(NoSmokingContent.this, copyrights, Toast.LENGTH_SHORT).show();
            }
        });
